...
class TestSegmentCylinder(unittest.TestCase):
    ...
    def setUp(self):
        self.p = pcl.load_XYZRGB("tests" + os.path.sep + "table_scene_mug_stereo_textured_noplane.pcd")
...
class TestPassthroughFilter(unittest.TestCase):
    ...
    def setUp(self):
        self.p = pcl.load_XYZRGB("tests/table_scene_mug_stereo_textured_noplane.pcd")
