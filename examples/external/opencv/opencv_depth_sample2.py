...
def main():
    ...
    color0 = cv2.imread('grabber_sequences/tiff/frame_20121214T142255.814212_rgb.tiff')
    # 16 bit Image
    ...
    depth0 = cv2.imread('grabber_sequences/tiff/frame_20121214T142255.814212_depth.tiff', cv2.IMREAD_ANYDEPTH | cv2.IMREAD_ANYCOLOR)
